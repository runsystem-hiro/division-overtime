...
KOT側に存在しない有効社員や退職日が設定された有効社員は削除せず、無効化候補として表示します。KOT側に存在しない場合と退職日が設定されている場合のどちらでも、すでに無効な社員は無効化候補へ再表示しません。従業員グループの「勤怠管理なし」「休職中」「業務委託」「セカンドからの出向者」は注意情報として表示し、自動除外はしません。
